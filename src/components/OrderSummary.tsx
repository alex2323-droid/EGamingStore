import { Zap, Lock, Gem, CheckCircle, Loader2, Tag } from 'lucide-react';
    ...
    <div className="glass-panel rounded-xl p-6 sticky top-24 border-t-4 border-t-primary">
      ...
      <div className="border-t border-glass-border pt-4 mb-4">
        ...
        <input 
          ...
          className="w-full bg-surface border border-glass-border rounded-lg py-2 px-3 text-white focus:border-primary focus:outline-none text-sm"
        />
      </div>
